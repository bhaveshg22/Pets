...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            setTitle(getString(R.string.addapet));
            invalidateOptionsMenu();
        }
        else {
            setTitle(getString(R.string.edir_pet));
    ...
    //function for updating the table with the new pet in it
...
//        SQLiteDatabase db = mDbHelper.getWritableDatabase();
        ...
        else
        {
            ...
            if(row==0)
            {
                Toast.makeText(this,getString(R.string.after_update_string),Toast.LENGTH_SHORT).show();
            }
            else
            {
                Toast.makeText(this,getString(R.string.Edit_updated_success),Toast.LENGTH_SHORT).show();
            }
        }
    }
...
//        / Bail early if the cursor is null or there is less than 1 row in the cursor
        ...
        if (cursor.moveToFirst()) {// Find the columns of pet attributes that we're interested in
            ...
            switch (gender) {
                case PetEntry.GENDER_MALE:mGenderSpinner.setSelection(1);
                    break;
